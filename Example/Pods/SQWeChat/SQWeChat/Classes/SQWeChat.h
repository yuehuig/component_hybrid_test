...
@protocol SQWeChatProtocol <NSObject>

@optional
- (void)wechatDidRecvShowMessageReq:(ShowMessageFromWXReq *)request;

- (void)wechatDidRecvLaunchFromWXReq:(LaunchFromWXReq *)request;

- (void)wechatDidRecvMessageResponse:(SendMessageToWXResp *)response;

- (void)wechatDidRecvAuthResponse:(SendAuthResp *)response;

- (void)wechatDidRecvAddCardResponse:(AddCardToWXCardPackageResp *)response;

- (void)wechatDidRecvChooseCardResponse:(WXChooseCardResp *)response;

- (void)wechatDidRecvChooseInvoiceResponse:(WXChooseInvoiceResp *)response;

- (void)wechatDidRecvSubscribeMsgResponse:(WXSubscribeMsgResp *)response;

- (void)wechatDidRecvLaunchMiniProgram:(WXLaunchMiniProgramResp *)response;

- (void)wechatDidRecvInvoiceAuthInsertResponse:(WXInvoiceAuthInsertResp *)response;

- (void)wechatDidRecvNonTaxpayResponse:(WXNontaxPayResp *)response;

- (void)wechatDidRecvPayInsuranceResponse:(WXPayInsuranceResp *)response;

/// log
- (void)wechatDidRecvLog:(NSString *)log;

@end

#pragma mark - SQWeChat
@interface SQWeChat : NSObject <WXApiDelegate>

@property (nonatomic, weak) id<SQWeChatProtocol> delegate;
